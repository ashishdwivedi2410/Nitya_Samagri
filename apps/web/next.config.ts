...
const nextConfig: NextConfig = {
  ...
  env: {
    ...
    NEXT_PUBLIC_APP_URL:         process.env.NEXT_PUBLIC_APP_URL         || "https://nityasamagri.com",
        ...
        headers: [
          ...
          { key: "Permissions-Policy",         value: "camera=(), microphone=(), geolocation=(self)" },
          {
            ...
            value: [
              ...
              "connect-src 'self' https://api.nityasamagri.com wss://api.nityasamagri.com https://lumberjack.razorpay.com",
